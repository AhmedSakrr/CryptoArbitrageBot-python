...
#    param = (api_version + "account_infos")
#    param = (api_version + "balances")   
    param2 = (api_version + "summary")
#    param = (api_version + "order/new")
#    
#    Bfx_send = Bfx_Post(param, pair1+pair2, trade_size, price, side, trade_type)    
#    Bfx_send.Post_Params()    
    
    Bfx_send2 = Bfx_Post(param2, pair1+pair2, trade_size, price, side, trade_type)
    Bfx_send2.Post_Params
