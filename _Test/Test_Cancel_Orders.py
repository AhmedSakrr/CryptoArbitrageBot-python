...
#    return Order_Cancelled
#
#Bl3p_Cancel_Order(ref)
#    



#def theRock_Cacncel_Order(ref):
#    
#    pair = pair1[0].lower() + pair2.lower()
...
#    return Order_Cancelled
#    
#theRock_Cacncel_Order(ref)


##print Gatecoin_Order(0.001, 'buy', 2000)
# 
