...
#Kraken_Asks, Kraken_Bids =  Kraken_Orderbook()
#Kraken_Liquid_Prices = (Weighted_Price(amount, Kraken_Asks),
#                        Weighted_Price(amount, Kraken_Bids))

                        
Bitstamp_Asks, Bitstamp_Bids =  Bitstamp_Orderbook()
Bitstamp_Liquid_Prices = (Weighted_Price(amount, Bitstamp_Asks),
                        Weighted_Price(amount, Bitstamp_Bids))
                        
#Gdax_Asks, Gdax_Bids =  Gdax_Orderbook()
#Gdax_Liquid_Prices = (Weighted_Price(amount, Gdax_Asks),
#                        Weighted_Price(amount, Gdax_Bids))
                        
#Bl3p_Asks, Bl3p_Bids =  Bl3p_Orderbook()
#Bl3p_Liquid_Prices = (Weighted_Price(amount, Bl3p_Asks),
#                        Weighted_Price(amount, Bl3p_Bids))


#theRock_Asks, theRock_Bids =  theRock_Orderbook()
#theRock_Liquid_Prices = (Weighted_Price(amount, theRock_Asks),
#                         Weighted_Price(amount, theRock_Bids))
               

#Gatecoin_Asks, Gatecoin_Bids =  Gatecoin_Orderbook()
#Gatecoin_Liquid_Prices = (Weighted_Price(amount, Gatecoin_Asks),
#                         Weighted_Price(amount, Gatecoin_Bids))
