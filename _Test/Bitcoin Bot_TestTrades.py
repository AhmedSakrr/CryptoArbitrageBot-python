...
Kraken_Buy_Order_ID =  str(Kraken_Open_Buy_Order['result']['txid'])

Bitstamp_Open_Buy_Order = Bitstamp_Order(buy_amount, 'buy', buy_price)
Bitstamp_Order_ID = str(Bitstamp_Open_Buy_Order['id'])

Gdax_Open_Buy_Order = Gdax_Order(buy_amount, 'buy', buy_price) #, 'True') Waiting to be margin approved
Gdax_Order_ID = str(Gdax_Open_Buy_Order['id'])
