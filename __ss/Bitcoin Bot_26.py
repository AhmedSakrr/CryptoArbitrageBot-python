...
def Trade_Logic_Complex_Open(Coin,
    ...
    while True:   
        ...
        if Buy_Filled is False:
            ...
            Sell_Filled = Check_Order_Filled(Coin, Exchange2, Sell_Order['Order'], 'sell') 
...
def Close(Arb):
    ...
    while True:
        ...
        Close_ID = Arb['Sell_Order']['Position_ID']
...
#                    Exchange.update({'Balances': Balances})            
        ...
        Funding_Cost = 0.001 + 0.001*no4hours * Short_Open_Amount * 
