...
Kraken = {'Name': 'Kraken', 'Shorting': True, 'Switched-On': True} # Can Short
...
Cex = {'Name': 'Cex', 'Shorting': False, 'Switched-On': True} # Can Short
Wex = {'Name': 'Wex', 'Shorting': False, 'Switched-On': True}
BitBay = {'Name': 'BitBay', 'Shorting': False, 'Switched-On': True}
Quoinex = {'Name': 'Quoinex', 'Shorting': False, 'Switched-On': True} # Can Short

Min_Bal = 20.00 # Min Balance to execute on
...
def Place_Market_Order(Coin, Exchange, amount, side, leverage):    
    ...
    if Test_Mode:
        ...
        if Exchange['Name'] == 'Kraken':        
            ...
            Quoinex_Open_Order = Quoinex_Market_Order(Coin, amount, side)
            Quoinex_Order_ID = Quoinex_Open_Order['id']
            Open_Order = {'ID': Quoinex_Order_ID, 'Order': {}}
...
def Trade_Logic_Simple(Coin,
    ...
    if Type == 'Open':
        ...
        if Exchange2['Name'] == 'Cex':
            Buy_Amount = Sell_Amount * 2.0
    ...
    while True:   
        ...
        if Filled is False:
            ...
            while True:
                ...
                Abort_Order = Execute_Market_Order(Coin, Exchange2, Sell_Amount, 'buy', Short_Leverage)
                
                Filled = Check_Order_Filled(Coin, Exchange2, Abort_Order['Order'], 'buy')
    ...
    while True:   
        ...
        if Sell_Order['Placed'] is False:
            ...
            if Filled is False:
                ...
                while True:
                    ...
                    Abort_Order = Execute_Market_Order(Coin, Exchange1,Buy_Amount,'sell',Long_Leverage)
                    
                    Filled = Check_Order_Filled(Coin, Exchange1,Abort_Order['Order'], 'sell')
        ...
        if Filled is False:
            ...
            if Filled is False:
                ...
                while True:
                    ...
                    Filled = Check_Order_Filled(Coin, Exchange2, Abort_Order['Order'], 'sell') 
        ...
        if Filled is False:
            ...
            while True:
                ...
                Filled = Check_Order_Filled(Coin, Exchange1, Abort_Order['Order'], 'buy') 
...
def Open(Opportunity):
    ...
    while True:
        ...
        if Limit_MOQ is True:
            ...
            Buy_MOQ = Exchange1['MOQs'][Coin]
            Sell_MOQ = Exchange2['MOQs'][Coin]
...
if __name__ == "__main__":
    ...
    for Exchange in Exchanges:
        MOQs = {}
        for Coin in Coins:
            MOQs.update(Get_MOQs(Coin, Exchange))
        Exchange.update({'MOQs': MOQs})
