...
def Bitfinex_MOQ():
    ...
    for attempt in range(1, Attempts):
        try:
            ...
            'Failed ot get Bitfinex MOQs on Attempt: %s' % attempt
            continue
        else:
    ...
    while True:
        ...
        if Sell_Order is False:
            ...
            if Buy_Filled is False:
                ...
                print 'Sell Order Failed at %s. Reversing Buy Order at %s.' %(Name1)
                log.write('\nSell Order Failed at %s. %s Reversing Buy Order at %s.'%(Name1))
        ...
        for attempt in range(1, Attempts):
            ...
            if Buy_Filled is False:
                ...
                print 'Checking if Buy Order at %s filled. Aattempt: %i' %(Name1, attempt)
                log.write('\nChecking if Buy Order at %s filled. Attempt: %i'%(Name1, attempt))
            ...
            if Sell_Filled is False:
                ...
                log.write('\nSell Order at %s did not fill on ttempt: %i'%(Name2, attempt))
        ...
        print 'Sold %s at %s for %s %s' %(Sell_Amount, Coin, Sell_Price, Fiat[0])
        log.write('\nSold %s at %s for %s %s' %(Sell_Amount, Coin, Sell_Price, Fiat[0]))
