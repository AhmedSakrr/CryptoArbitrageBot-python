...
def Place_Limit_Order(Coin, Exchange, amount, side, price, Leverage):
    ...
    if Test_Mode:
        ...
        try:
            ...
            print 'Limit Order at %s Failed' %(Exchange['Name'])
            log.write('\nLimit Order at %s Failed' %(Exchange['Name']))
            return False
                                
        else:
            print 'Limit Order at %s Placed' %(Exchange['Name'])
            log.write('\nLimit Order at %s Placed' %(Exchange['Name']))
...
if __name__ == "__main__":
    ...
    if Jumpstart_Script is False:
        ...
        Initial_Target_Profit = 100.0 # Percent (after fees and slippage)
