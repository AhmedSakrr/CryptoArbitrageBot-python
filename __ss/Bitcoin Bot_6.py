...
def Update(Arb):
    ...
    if Spread_Out < Opportunity['Close_Min_Spread']:
        Opportunity['Close_Min_Spread'] = Spread_Out
...
#    Enter_Target = Target_Profit #easier entry price for testing
    ...
    Opportunities.append({'Long': Exchange1,
                          ...
                          'Open_Max_Spread': -100.0,
                          
                          'Close_Spread': Spread_Out,
                          'Close_Target': 100.0,
                          'Close_Min_Spread': 100.00,
...
def Update_Opportunities(Opportunity):      
    ...
    if Spread_In > Opportunity['Open_Max_Spread']:
        Opportunity['Open_Max_Spread'] = Spread_In
