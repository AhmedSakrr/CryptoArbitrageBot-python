...
def Open(Opportunity):  
    ...
    if spread > Min_Spread:        
        ...
        if Exchange1['EUR'] > Min_Bal and Exchange2['EUR'] > Min_Bal :
            ...
            Trade_Amount_BTC = Trade_Amount_EUR / Exchange1['buy'] # This might be over the sell price //double check
            ...
            log_file.write('. Attempting Trade')
...
#                    break
            ...
            log_file.write('. Shorted ' + str(Trade_Amount_BTC) + pair1[0] + ' at ' + str(Exchange2['Name'])+'. ')
...
def Close(Open_Arb):
    ...
    Exchange1 = Open_Arb[0]
    Exchange2 = Open_Arb[1]      

    Total_Open_Balance = Open_Arb[3]
