    ...
    while True:   
        ...
        if Sell_Order['Placed'] is False:
            ...
            if Filled is False:
                ...
                Abort_Price = Get_Prices(Exchange1)['sell'] # delete this and execute market order
                Abort_Order = Execute(Exchange1,Buy_Amount,'sell',Abort_Price) # delete this and execute market order
        ...
        if Filled is False:
            ...
            if Filled is False:
                ...
                Abort_Price = Get_Prices(Exchange2)['buy'] # delete this and execute market order
                Abort_Order = Execute(Exchange2,Sell_Amount,'buy',Abort_Price) # delete this and execute market order
...
def Close(Arb):    
    ...
    while True:
        ...
        Buy_Cost = Exchange2['buy_fee']/100 * -Exchange2[pair1[0]]
        Sell_Cost = Exchange1['sell_fee']/100 * Exchange1[pair1[0]]
        
        Sell_Amount = Exchange1[pair1[0]] - Sell_Cost
        Buy_Amount = -Exchange2[pair1[0]] - Buy_Cost # Turn back to positive for order
