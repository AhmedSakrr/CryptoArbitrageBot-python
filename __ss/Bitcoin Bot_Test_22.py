...
def Close(Arb):    
    ...
    ###########################################################################
        ...
        for opportunity in Opportunities:
            if  Name1 == opportunity[0]['Name'] and Name2 == opportunity[1]['Name']:                
                ...
                opportunity[8] = -0.0 # reset the exit spread tracker
                opportunity[9] = 0.0 # reset the entry spread tracker
