...
def Trade_Logic_Close(Coin,
    ...
    while True:   
        ...
        if Sell_Order['Order'] is False:
            return ({'Closed': False}, {'Order': False}) # doesn't matter, nothing exceuted yet
        ...
        if Filled is False:
            ...
            return ({'Closed': False}, {'Order': False})
...
def Close(Arb):
    ...
    while True:
        ...
        if Buy_Order['Closed'] is False or Sell_Order['Order'] is False:
            break
