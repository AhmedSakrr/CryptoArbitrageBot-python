...
def Arbitrage(Exchanges):
    ...
    if Profit > 1.0 and Exchange1['EUR'] > 10 and Exchange2['EUR'] > 10:
        print Exchange1['Name']+'_'+Exchange2['Name'], Profit, 'Entry Found'
        
        print 'Attempting to buy ' + Exchange1['Name']
        print '--Place actual order here-- (this is fake)'
        print 'Bought ' + str(Exchange1['EUR']/buy) + pair1[0] + ' at ' + str(Exchange1['Name'])
        
        print 'Attempting to short ' + Exchange2['Name']
        print '--Place actual order here-- (this is fake)'
        print 'Shorted ' + str(Exchange2['EUR']/sell) + pair1[0] + ' at ' + str(Exchange2['Name'])
        
        open_arbs = open_arbs.append(Exchanges)
        
#        for exchange in open_order_exchanges:
#            print 'Open Order: '+exchange[0]['Name']+'_'+exchange[1]['Name']
...
Exchanges = [Kraken, Bitstamp, Gdax, TheRock, Bl3p, Gatecoin] # add xBTCe when ready
for ex in Exchanges:
    print ex
...
for Permuatation in Permuatations:
    #Try:
    Arbitrage(Permuatation)       
        
#        except:
#            print Permuatation[0]['Name']+'_'+Permuatation[1]['Name'] +' Failed'
#            continue
