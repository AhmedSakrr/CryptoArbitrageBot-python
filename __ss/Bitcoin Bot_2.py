...
def Open(Opportunity):
    ...
    while True:
        ...
        if Balance1 > Balance2:
            Trade_Amount_EUR = 0.999*Balance2        
        else:
            Trade_Amount_EUR = 0.999*Balance1
...
def Close(Arb):    
    ...
    while True:
        ...
        Buy_Amount = round(-Exchange2[pair1[0]] + Buy_Cost, 8)
        Sell_Amount = round(Exchange1[pair1[0]] - Sell_Cost, 8)
