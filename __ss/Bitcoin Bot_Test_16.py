...
def Close(Arb):    
    ...
    while True:
        ...
        print 'Exiting trade, buying - Liquid Price is {} and Max Price is {}'.format(Liquid_Price, Max_Price)
        # Check if there is enough liquidity for the sell order
        ...
        Sell_Price = Liquid_Price       
        print 'Exiting trade, selling - Liquid Price is {} and Min Price is {}'.format(Liquid_Price, Min_Price)
        # Calc Fees and Execute the Trade Logic function, this is complicated
    ...
    ###########################################################################
        ...
        Buy_Amount2 = Buy_Amount - Buy_Cost
        Sell_Amount1 = Sell_Amount - Sell_Cost
