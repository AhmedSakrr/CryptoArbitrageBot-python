...
Entry_Spread = Target_Profit + 4*slippage # 4 transactoins in total so need to account for impact on profit
...
log_file = open('Log_'+str(datetime.now())[0:10]+'.txt', "w")
...
while True:
    ...
    log_file = open('Log_'+str(datetime.now())[0:10]+'.txt', "a")
