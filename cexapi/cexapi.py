...
class API(object):
    ...
    def __post(self, url, param, time_out):  # Post Request (Low Level API call)
    ...
    def api_call(self, method, param={}, private=0, couple=''):  # api call (Middle level)
        ...
        if private == 1:  # add auth-data if needed
            ...
            time_out = 30
        answer = self.__post(url, param, time_out)  # Post Request
    ...
    def fees(self, couple='GHS/BTC'):
        return self.api_call('get_myfee'['data'][couple], {}, 0)
